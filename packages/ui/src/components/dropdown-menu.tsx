  ...
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      `flex cursor-pointer select-none items-center rounded-md px-2 py-1.5 text-sm outline-none
       transition-colors focus:bg-neutral-100 data-[state=open]:bg-neutral-100
...
>(({ className, inset, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      inset && 'pl-8',
      destructive
        ? 'text-error-600 focus:bg-error-50 dark:text-error-400 dark:focus:bg-error-900/20'
  ...
  <DropdownMenuPrimitive.CheckboxItem
    ...
    className={cn(
      `relative flex cursor-pointer select-none items-center rounded-md py-1.5 pl-8 pr-2 text-sm outline-none
       transition-colors focus:bg-neutral-100 data-[disabled]:pointer-events-none data-[disabled]:opacity-50
       dark:focus:bg-neutral-800`,
      className
    )}
    checked={checked}
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn('px-2 py-1.5 text-sm font-semibold text-neutral-500 dark:text-neutral-400', inset && 'pl-8', className)}
    {...props}
  />
));
